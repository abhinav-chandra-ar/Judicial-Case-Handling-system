<%@ Page Title="" Language="C#" MasterPageFile="~/PetitionerMasterPage2.master" AutoEventWireup="true" CodeFile="PetitionerMailCompose1.aspx.cs" Inherits="PetitionerMailCompose1" %>
                         ...
                         <div class="box-body">
                             <div class="row">
                                 <div class="col-md-3 col-sm-4">
                                     ...
                                     <!-- compose message btn -->
                                   <%--  <a class="btn btn-block btn-primary" data-toggle="modal" data-target="#compose-modal" href="PetitionerMail.aspx"><i class="fa fa-pencil"></i> Inbox</a>--%>
                                     <!-- Navigation - folders-->
