...
public partial class AdminDeletePolice1 : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        string cmdstr = "select * from police where status=1";
    ...
    protected void DataList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string sss = "update police set status=2 where pid=" + id + "";
        ob1.exec(sss);
