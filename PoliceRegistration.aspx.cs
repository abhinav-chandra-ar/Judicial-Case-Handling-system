...
public partial class PoliceRegistration : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DropDownList10.Items.Insert(1, new ListItem("Fort ", "1"));
        DropDownList10.Items.Insert(2, new ListItem("Sreekariyam", "2"));
        DropDownList10.Items.Insert(2, new ListItem("Medical College", "3"));
        DropDownList10.Items.Insert(2, new ListItem("Kazhakuttam ", "4"));
        DropDownList10.Items.Insert(2, new ListItem("Cantonment", "5"));
        DropDownList10.Items.Insert(2, new ListItem("Coastal", "6"));
        DropDownList10.Items.Insert(2, new ListItem("Karamana", "7"));
        DropDownList10.Items.Insert(2, new ListItem("Kovalam", "8"));
        DropDownList10.Items.Insert(2, new ListItem("Mannanthala", "9"));
        DropDownList10.Items.Insert(2, new ListItem("Museum", "10"));
        DropDownList10.Items.Insert(2, new ListItem("Nemom", "11"));
        DropDownList10.Items.Insert(2, new ListItem("Peroorkada ", "12"));
        DropDownList10.Items.Insert(2, new ListItem("Pettah", "13"));
        DropDownList10.Items.Insert(2, new ListItem("Thampanoor", "14"));
        DropDownList10.Items.Insert(2, new ListItem("Thiruvallam", "15"));
    }
    public int getid()
    {
        int c = 0;
        ob.dr = ob.ret_dr("select isnull(max(pid),300)+1 from police");
        if (ob.dr.Read())
        {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!ob.dr.Read())
            {
                ...
                string str = "insert into police values(" + uid + ",'" + TextBox11.Text + "','" + TextBox8.Text + "','" + DropDownList10.SelectedItem.ToString() + "','" + dob + "','" + TextBox7.Text + "','" + TextBox10.Text + "','" + TextBox2.Text + "','" + DropDownList6.SelectedItem.ToString() + "','" + TextBox1.Text + "','" + TextBox3.Text + "',0,0)";
                ob.exec(str);
