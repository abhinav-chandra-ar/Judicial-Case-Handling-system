<%@ Page Title="Page Title" Language="C#" MasterPageFile="~/AdvocateMasterPage.master" AutoEventWireup="true" CodeFile="AdvocateHomepage1.aspx.cs" Inherits="AdvocateHomepage1" %>
...
--%>
            ...
            <ItemTemplate>
               ...
               <%-- <asp:Image ID="imgEmp" runat="server" Width="200px" Height="200px" ImageUrl='<%# Bind("uphoto") %>' style="padding-left:40px"/><br />
                ...
                <asp:Label ID="Label5" runat="server" Text='<%# Bind("adid") %>' ></asp:Label>
                ...
                <asp:Label ID="Label11" runat="server" Text='<%# Bind("adcode") %>' ></asp:Label>
                ...
                <asp:Label ID="Label3" runat="server" Text='<%# Bind("adtype") %>' ></asp:Label>  
