<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdvocateRegistration.aspx.cs" Inherits="AdvocateRegistration" %>
...
Display="Dynamic" />
  ...
  <asp:Label ID="Label1" runat="server" Text="Advocate ID:" Font-Names="Arial" 
        ...
        <br />
        <br />
         <asp:Label ID="Label2" runat="server" Text="Court Reg Date:" Font-Names="Arial" 
             Font-Size="Medium"></asp:Label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:TextBox 
             ID="TextBox6" runat="server" Height="26px" Width="225px" ></asp:TextBox> 
             <br />
        <br />
        <asp:Label ID="Label12" runat="server" Text="Upload Photo:"></asp:Label>             
             <div style="margin-top:-18px;margin-left:155px;width:225px"> 
                 <asp:FileUpload ID="FileUpload4" runat="server" 
                     Width="225px" Height="29px" 
                     onload="FileUpload4_Load" BorderStyle="None"/> 
