...
public partial class AdminDeletePetitioner1 : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        string cmdstr = "select * from petitioner where status=1";
    ...
    protected void DataList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string sss = "update petitioner set status=2 where petid=" + id + "";
        ob1.exec(sss);
