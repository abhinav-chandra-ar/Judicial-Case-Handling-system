...
public partial class AdminDeleteAdvocate1 : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        string cmdstr = "select * from advocate where status=1";
    ...
    protected void DataList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string sss = "update advocate set status=2 where adid=" + id + "";
        ob1.exec(sss);
