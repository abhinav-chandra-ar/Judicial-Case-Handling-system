...
public partial class AdminApprovePetitioner1 : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        string cmdstr = "select * from petitioner where status=0";
    ...
    protected void DataList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string sss = "update petitioner set status=1 where petid=" + id + "";
        ob1.exec(sss);
        ob.dr = ob.ret_dr("select username from petitioner where petid=" + id + "");
        if (ob.dr.Read())
        {
