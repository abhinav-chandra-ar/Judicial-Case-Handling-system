...
public partial class PoliceCourtPetition1 : System.Web.UI.Page
{
    ...
    {
        ob.dr = ob.ret_dr("select * from Petition where Petitionid='" + DropDownList4.SelectedItem.ToString() + "' and status=1 and pstation='" + pstation + "'");
        if (ob.dr.Read())
        {
    ...
    {
        string sss = "update Petition set status=3 where Petitionid='" + DropDownList4.SelectedItem.ToString() + "'";
        ob1.exec(sss);
        Label11.Visible = true;
        Label11.Text = "Petition Solved and Closed By Police";
    }

    protected void Button2_Click(object sender, EventArgs e)
    {
        string sss = "update Petition set status=4 where Petitionid='" + DropDownList4.SelectedItem.ToString() + "'";
        ob1.exec(sss);
        Label11.Visible = true;
        Label11.Text = "Petition Registered successfully";
    }
}