<%@ Page Title="" Language="C#" MasterPageFile="~/AdvocateMasterPage.master" AutoEventWireup="true" CodeFile="AdvocateMailCompose1.aspx.cs" Inherits="AdvocateMailCompose1" %>
                         ...
                         <div class="box-body">
                             <div class="row">
                                 <div class="col-md-3 col-sm-4">
                                     ...
                                     <!-- compose message btn -->
                                     <%--<a class="btn btn-block btn-primary" data-toggle="modal" data-target="#compose-modal" href="AdminMail.aspx"><i class="fa fa-pencil"></i> Inbox</a>--%>
                                     <!-- Navigation - folders-->
