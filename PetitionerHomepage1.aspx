<%@ Page Title="" Language="C#" MasterPageFile="~/PetitionerMasterPage2.master" AutoEventWireup="true" CodeFile="PetitionerHomepage1.aspx.cs" Inherits="PetitionerHomepage1" %>
...
--%>
            ...
            <ItemTemplate>
               ...
               <%-- <asp:Image ID="imgEmp" runat="server" Width="200px" Height="200px" ImageUrl='<%# Bind("uphoto") %>' style="padding-left:40px"/><br />
                ...
                <asp:Label ID="Label5" runat="server" Text='<%# Bind("petid") %>' ></asp:Label>
                 </div>
                 <br />

                <div style="margin-left: 10px;">
                <b>Petioner  ID Proof:</b>

                <asp:Label ID="Label11" runat="server" Text='<%# Bind("petidno") %>' ></asp:Label>
                </div>
