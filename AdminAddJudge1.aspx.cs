...
public partial class AdminAddJudge1 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DropDownList10.Items.Insert(1, new ListItem("District Court", "1"));
        DropDownList10.Items.Insert(2, new ListItem("subordinate courts", "2"));
    }
    public int getid()
    {
        int c = 0;
        ob.dr = ob.ret_dr("select isnull(max(jid),300)+1 from judge");
        if (ob.dr.Read())
        {
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            if (!ob.dr.Read())
            {
                ...
                string str = "insert into judge values(" + uid + ",'" + TextBox11.Text + "','" + TextBox8.Text + "','" + DropDownList10.SelectedItem.ToString() + "','" + dob + "','" + TextBox7.Text + "','" + TextBox10.Text + "','" + TextBox2.Text + "','" + DropDownList6.SelectedItem.ToString() + "','" + TextBox1.Text + "','" + TextBox3.Text + "',0,0)";
                ob.exec(str);
                ob1.exec("insert into Login values(" + uid + ",'" + TextBox1.Text + "','" + TextBox3.Text + "',5)");
                Label11.Visible = true;
