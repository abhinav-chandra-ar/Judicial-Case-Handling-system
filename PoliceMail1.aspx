<%@ Page Title="" Language="C#" MasterPageFile="~/PoliceMasterPage2.master" AutoEventWireup="true" CodeFile="PoliceMail1.aspx.cs" Inherits="PoliceMail1" %>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3 col-sm-4">
                            ...
                            <!-- compose message btn -->
                            <%--<a class="btn btn-block btn-primary" data-toggle="modal" data-target="#compose-modal" href="PoliceMailCompose.aspx"><i class="fa fa-pencil"></i> Compose Message</a>--%>
                            <!-- Navigation - folders-->
                            <div style="margin-top: 15px;">
                                <ul class="nav nav-pills nav-stacked">
                                    <li class="header">Folders</li>
                                    <li class="active"><a href="PoliceMail.aspx"><i class="fa fa-inbox"></i> Inbox </a></li>
