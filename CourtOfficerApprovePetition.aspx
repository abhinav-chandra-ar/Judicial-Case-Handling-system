<%@ Page Title="" Language="C#" MasterPageFile="~/CourtOfficerMasterPage2.master" AutoEventWireup="true" CodeFile="CourtOfficerApprovePetition.aspx.cs" Inherits="CourtOfficerApprovePetition" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="box">
                           <div class="box-header">
                               <h3 class="box-title">Admin Approve Petition</h3>                                    
                           </div><!-- /.box-header -->
     ...
     <h3 class="box-title">Court Officer Approve Petition</h3>  
   
   <br />
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;       
                         <asp:Label ID="Label18" runat="server" 
        Text="Incident ID:" Font-Names="Arial" Font-Size="Medium"></asp:Label>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
  ...
  &nbsp;&nbsp;&nbsp;
   ...
   Width="110px"/> 
    ...
    <br /> 
     &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button 
            ID="Button3" runat="server" class="btn btn-primary w-md" Height="32px" Text="Allocated " onclick="Button1_Click"  
