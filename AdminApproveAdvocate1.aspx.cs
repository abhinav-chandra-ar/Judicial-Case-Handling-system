...
public partial class AdminApproveAdvocate1 : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        ...
        string cmdstr = "select * from advocate where status=0";
    ...
    protected void DataList1_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        string sss = "update advocate set status=1 where adid=" + id + "";
        ob1.exec(sss);
        ob.dr = ob.ret_dr("select username from advocate where adid=" + id + "");
        if (ob.dr.Read())
        {
