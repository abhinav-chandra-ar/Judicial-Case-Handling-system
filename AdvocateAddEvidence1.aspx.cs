...
public partial class AdvocateAddEvidence1 : System.Web.UI.Page
{
    DbConnection ob = new DbConnection();
    DbConnection ob1 = new DbConnection();
    public static string document2 = "", document3 = "", document4 = "", document21 = "", document31 = "", document41 = "", document411 = "", document22 = "", document32 = "", document42 = "", document23 = "", document33 = "", document43 = "", document211 = "", document311 = "", aduname = "";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      //  Label1.Text = aduname;
        TextBox16.Text = Session["aduname"].ToString();
        if (!IsPostBack)
        {
    ...
    public void getgrid()
    {
        ob.dr = ob.ret_dr("select distinct caseid from hearing where (petadvuname='" + aduname + "' and (cstatus='Active')) or  (respadvuname='" + aduname + "' and (cstatus='Active'))");
        while (ob.dr.Read())
        {
